...
namespace STEM.Surge
{
    ...
    public abstract class _DeploymentController : STEM.Sys.Serializable, IDisposable
    {
        ...
        /// </summary>
        [Category("Sandboxing")]
        [DisplayName("Minutes Of Inactivity"), DescriptionAttribute("How many minutes of inactivity should be allowed before sandboxes are torn down?")]
