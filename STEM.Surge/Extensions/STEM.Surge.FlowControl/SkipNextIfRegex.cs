...
namespace STEM.Surge.FlowControl
{
    ...
    [DisplayName("SkipNextIfRegex")]
    [Description("Skip the next Instruction in the InstructionSet if the string specified in Test String matches the RegEx filter specified in RegEx Filter.")]
    public class SkipNextIfRegex : Instruction
    {
        [Category("Flow")]
