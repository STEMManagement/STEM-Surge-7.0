...
namespace STEM.Surge.FlowControl
{
    ...
    [DisplayName("DoNextIfExceptionsContain")]
    [Description("Do the next Instruction in the InstructionSet if the Exceptions Collection contains the 'Exception Like' string fragment.")]
    public class DoNextIfExceptionsContain : Instruction
    {
        [Category("Flow")]
