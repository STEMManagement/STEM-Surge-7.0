...
namespace STEM.Surge.Compression
{
    ...
    [DisplayName("UnTarGZ")]
    [Description("UnTarGZ a file.")]
    public class UnTarGZ : Instruction
    {
        [Category("Source")]
        [DisplayName("Source File"), DescriptionAttribute("The path and filename of the zip file to be un-tared.")]
