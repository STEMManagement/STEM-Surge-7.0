...
namespace STEM.Surge.Compression
{
    ...
    [DisplayName("Tar In Container")]
    [Description("Tar data in a container where the data is a Dictionary<string, byte[]>.")]
    public class TarInContainer : Instruction
    {
        ...
        [Description("The container with the data to be tared.")]
        public ContainerType TargetContainer { get; set; }

        public TarInContainer()
        {
        ...
        protected override bool _Run()
        {
            try
            {
                ...
                {
                    using (TarOutputStream tStream = new TarOutputStream(s))
                    {
