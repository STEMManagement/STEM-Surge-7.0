...
namespace STEM.Surge.Compression
{
    ...
    [DisplayName("Container To UnTarGZ")]
    [Description("UnTarGZ data in a container to a Dictionary<string, byte[]>.")]
    public class UnTarGZInContainer : Instruction
    {
        ...
        [Description("The container with the data to be UnTared and un GZipped.")]
        public ContainerType TargetContainer { get; set; }

        public UnTarGZInContainer()
        {
        ...
        protected override bool _Run()
        {
            try
            {
                ...
                {
                    using (GZipInputStream zStream = new GZipInputStream(s))
                    {
